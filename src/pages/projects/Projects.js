...
const ai_projects = [
  {
    ...
    "description": "Harry Potter and a Data Scientist: Write a  multi-class classifier using gradient descent optimization algorithm to replace the bewitched Sorting Hat and save Hogwarts! 🎩🧙‍♂️",
    "isFork": false,
    "languages": [
      {
        "name": "Python",
  ...
  },
  {
    ...
    "description": "Univariable Linear regression model ( Cars dataset Milage/Price ) 🛣️ 🚗 💰",
    "isFork": false,
    "languages": [
      {
        "name": "Python",
  ...
  },
  {
    ...
    "description": "Program an AI ant colony manager to help them cross a graph in as few strokes as possible, the result can be displayed with a visualizer 🐜🐜🐜",
    "isFork": false,
    "languages": [
      {
        "name": "C",
  ...
  },
  {
    ...
    "description": "Create a VM “arena” in which programs 'Champions' will fight against each others. You will also create an assembler to compile those Champions, and make Champion. ",
    "isFork": false,
    "languages": [
      {
        "name": "C",
  ...
  },
  {
    ...
    "description": "🤼 2 players take turns placing the piece that the master of the game, gives them, earning points.",
    "isFork": false,
    "languages": [
      {
        "name": "C",
...
const web_projects = [
  {
    ...
    "description": "Mise en place d'une plateforme de teleconsultation et teleexpertise echographiques.",
    "isFork": false,
    "languages": [
      {
        "name": "Django",
  ...
  },
  {
    ...
    "description": "🏠 Real Estate Website built using Django, and PostgresSQL for the database",
    "isFork": false,
    "languages": [
      {
        "name": "Django",
  ...
  },
  {
    ...
    "description": "Backend API for an app using ExpressJS and MongoDB for a NO SQL database, with JWT for the authentification.",
    "isFork": false,
    "languages": [
      {
        "name": "NodeJS",
  ...
  },
  {
    ...
    "url": "/",
    "description": "My Portfolio a living and changing collection of records that reflect your accomplishments, skills, experiences, and attributes. It highlights and showcases samples of some of my best work, along with life experiences, values and achievements trophy.",
    "isFork": false,
    "languages": [
      {
        "name": "ReactJS",
...
const mobile_projects = [
  {
    ...
    "description": "Application for Muslims to find Qibla 🧭, Facilitate counting of Tasbeeh 🧮 & Find mosques 🕌☪️️",
    "isFork": false,
    "languages": [
      {
        "name": "Flutter",
  ...
  },
  {
    ...
    "description": "💰 Crypto Currency BTC, ETH, LTC, XRP, XMR price checking App using flutter",
    "isFork": false,
    "languages": [
      {
        "name": "Flutter",
  ...
  },
  {
    ...
    "description": "⚡💬  Build a modern messaging app where users can sign up and log in to Chat.",
    "isFork": false,
    "languages": [
      {
        "name": "Flutter",
  ...
  },
  {
    ...
    "description": "💪📏  Body Mass Index Calculator App using flutter to  measure the body fat based on height and weight for men and women.",
    "isFork": false,
    "languages": [
      {
        "name": "Flutter",
...
const unix_projects = [
  ...
  },
  {
    ...
    "description": "✔️ Program (using Termcaps) which allow you to pick from a list of choices and return it to your shell.",
    "isFork": false,
    "languages": [
      {
        "name": "C",
...
const graphic_projects = [
  {
    ...
    "description": "👷 Creating a simplified 3D graphic representation of a relief landscape using minilibX.",
    "isFork": false,
    "languages": [
      {
        "name": "C",
